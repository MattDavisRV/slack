...
func TestNewSectionBlock(t *testing.T) {
	...
	sectionBlock := NewSectionBlock(textInfo, nil, nil, SectionBlockOptionBlockID("test_block"), SectionBlockOptionExpand(true))
	...
	assert.Equal(t, sectionBlock.Expand, true)
